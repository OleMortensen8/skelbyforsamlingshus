...
try {
    ...
    if (!$mailHost || !$mailUsername || !$mailPassword || !$mailFrom) {
        throw new \RuntimeException('Missing required mail configuration environment variable(s) (MAIL_HOST/MAIL_USERNAME/MAIL_PASSWORD/MAIL_FROM); confirmation email not sent.');
    }
    ...
    $mail3->Body = 'Kære ' . $name .
        '<br/> Vi har bekræftet din booking til ' . $dato . ' og vil kontakte dig igen 7 dage inden <br/>
